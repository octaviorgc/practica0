...
<body>
	...
	<form name="envia-get_frm" action="enviardatos.php" method="get" enctype="application/x-www-form-urlencoded">
...
<hgroup><h1>Formulario enviado por el m&eacute;todo POST</h1></hgroup>
	<form name="envia-post_frm" action="enviardatos.php" method="post" enctype="application/x-www-form-urlencoded">
	<label>Ingresa tu Nombre:</label>
	<input type= "text" name="nombre_txt" />
	<br><br>
	<label>Ingresa tu Password:</label>
